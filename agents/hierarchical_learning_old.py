...
class HierarchicalLearner:
    def __init__(self, start_phase_ix, feature_type, num_columns,
                 ...
                 delete_oldest_data_point_every_phases, learn_from_step_phases, learn_every_step_until, number_of_rollouts_per_child_phases,
                 feature_directors, standardize_features, max_batch_size, learn_every_after, ew=False, ttb=False,
                 random_init_weights=False, do_sgd_update=False, ridge=False, one_se_rule=False, stnw=False, nonnegative=False):
